...
def get_dataset(dataset_name,
                target_folder=r"/home/a/q/Test/Data",
    ...
    if  dataset_name == 'PaviaU':
        ...
        # Load the image
        img = open_file(folder + 'Indianpines.mat')
        img = img['indian_pines_corrected']

        rgb_bands = (43, 21, 11)  # AVIRIS sensor

        gt = open_file(folder + 'Indianpines_gt.mat')['indian_pines_gt']
        ...
        img = open_file(folder + 'salinas.mat')['HSI_original']
        rgb_bands = (43, 21, 11)  # AVIRIS sensor

        gt = open_file(folder + 'salinas_gt.mat')['Data_gt']
...
class HyperX(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        # Load the data into PyTorch tensor  转换为tensor
